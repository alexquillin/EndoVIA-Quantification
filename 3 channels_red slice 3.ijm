...
run("Duplicate...", "title=mask duplicate range=3");
selectWindow("mask");
...
Plot.create("Compared_Intensities", "slice_2", "slice_3");
Plot.add("Circle", Table.getColumn("slice_2", "Results"), Table.getColumn("slice_3", "Results"));
Plot.setStyle(0, "black,black,1.0,Circle");

Fit.doFit("Straight Line", Table.getColumn("slice_2", "Results"), Table.getColumn("slice_3", "Results"));
Fit.plot;

Plot.setAxisLabelSize(14.0, "plain");
Plot.setFontSize(14.0);
Plot.setXYLabels("slice_2", "slice_3");
